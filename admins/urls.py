...
urlpatterns= [
    ...
    path('edit_subcategory/<str:slug>/',views.edit_subcategory,name='edit_subcategory'),
    ...
    path('ajax_load_subcategory/', views.load_subcategory, name='ajax_load_subcategory'), 
